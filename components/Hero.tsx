...
const Hero  = () => {
  useGSAP(() => {
    ...
    gsap.from(textsplit.lines, { y: 100, duration: 0.8, stagger: 0.1 , ease:"power4.out" });
    gsap.from("#hero", { scale: 3, duration: 0.5, ease: "power4.out" });
    gsap.fromTo(
      "#hero",
      { y: -2 },
  ...
  return (
    ...
    >
      ...
      <div
        id="text"
        className="relative w-full h-full items-center justify-between flex flex-col bg-zinc-700/20 py-30 sm:py-50 lg:py-5 xl:py-20 px-20 "
      >
        ...
        <div id="fan" className="w-full flex items-center justify-center">
          <Image
            src={"/fan.png"}
            alt="fan"
            width={100}
